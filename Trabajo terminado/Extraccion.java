...
public class Extraccion extends Operacion {
	...
	//Extrae el monto ingresado desde la cuenta indicada.
	public void extraerFondos(Cuenta cuenta, int monto) throws ErrorSaldoInsuficiente, ErrorAlIntroducirSaldo{ 
		
		//Si el monto no es un múltiplo de 100, imprime el mensaje de error. Esto se debe a que el cajero solo dispensa billetes de 1000, de 500 y de 100.
		if(monto % 100 != 0) {
